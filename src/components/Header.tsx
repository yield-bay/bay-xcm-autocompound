...
export default function Header() {
  return (
    <div className="relative flex justify-between items-center w-full px-9 sm:px-11 lg:px-[120px] py-[38px] sm:py-12 z-10 font-bold text-base leading-6 sm:leading-8 text-black bg-gray-100 transition duration-200">
      <Link href="/">
