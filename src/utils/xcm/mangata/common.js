    ...
    run = async () => {
        ...
        if (shouldMintLiquidity) {
            ...
            if (numReserved.toNumber() === 0) {
                ...
                console.log("pool.firstTokenAmountFloat", pool.firstTokenAmountFloat, "pool.secondTokenAmountFloat", pool.secondTokenAmountFloat, "firstTokenAmount", firstTokenAmount, "expectedSecondTokenAmount", expectedSecondTokenAmount);
